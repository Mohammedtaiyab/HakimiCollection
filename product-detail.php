            ...
            <div class="col-12 col-md-6">
              <div class="slider-wrapper">
                <div class="slider-for">
                  ...
                  ?>
 <a class="slider-for__item ex1 fancybox-button" href='images/product/<?php echo $imgs[0]; ?>' data-fancybox-group="fancybox-button" title="Lorem ipsum dolor sit amet">
                    <img src='images/product/<?php echo $imgs[0]?>' alt="Zoom Image" />
                  </a>

                  <?php for ($i=1; $i < count($imgs); $i++) { ?>
                    <a class="slider-for__item ex1 fancybox-button" href='images/product/<?php echo $imgs[$i]; ?>' data-fancybox-group="fancybox-button" title="Lorem ipsum dolor sit amet">
                    <img src='images/product/<?php echo $imgs[$i]?>' alt="Zoom Image" />
                  </a>
                ...
                <div class="col-12 col-md-12">
                  ...
                  <div class="pro-counter">
                    ...
                    <form method="POST" action='?action=add&pid=<?php echo $productitem[0]['proID']; ?>'>
                      ...
                      <div class="col-md-4">
                        <div class="pro-single-info" class="form-control">Size</div>
                      </div>
                      <div class="col-md-8">
                        <select class="form-control" name="size" id="size" require>
                        <?php
                        $str_arr = preg_split("/\,/", $productitem[0]['Size']);
                
                        foreach ($str_arr as $siz) { ?>
                      ...
                      <div class="row input-group control-group">
                        <div class="col-md-4">
                        <div class="pro-single-info" class="form-control">Color</div>
                        </div>
                     <div class="col-md-8">
                     <select class="form-control" name="color" id="color" require>
                        <?php
                        $str_arrcol = preg_split("/\,/", $productitem[0]['Color']);
                
                        foreach ($str_arrcol as $col) { ?>
                      ...
                      <div class="row input-group control-group">
                        <div class="col-md-4">
                        <div class="pro-single-info" class="form-control">Quantity</div>
                        </div>
                     <div class="col-md-8">
                     <select class="form-control quantity" name="quantity" id="quantity<?php echo $productitem[0]['proID']; ?>" require>
                        <?php
                        $str_arrcol = preg_split("/\,/", $productitem[0]['Color']);
