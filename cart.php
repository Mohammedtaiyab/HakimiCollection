                  ...
                  <td class="col-12 col-md-4">
                    ...
                    <!--   <span class="pro-info">Category</span> -->
                        ...
                        <div class="item-attributes">
                          <p> <strong>Size: <?php echo $cart['item_size'];?> </strong> </p>
                          <p> <strong>Color: <?php echo $cart['item_color'];?> </strong></p>
                        </div>
                        <div class="item-controls">
...
$i=1;
foreach($usercart as $cart){ 
$msg=$msg."*Item".$i." ".$cart['item_name']."*--Size(".$cart['item_size'].")--Color(".$cart['item_color'].")--Qty(".$cart['item_quantity'].")\n\n\n\n\n\n\n\n\n\n";
...
<a href='https://wa.me/919660877053?text=<?php echo $msg; ?>' target="_blank" class="btn btn-warning btn-block swipe-to-down mt-2" name="whatsapp">Order On Whatsapp!</a>
        </div>
  </div>
