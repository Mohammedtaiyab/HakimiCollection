                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          ...
                          <td>".$row['Id']."</td>
                            ...
                            <td>";
                              if($row['Status']==1){
                                  echo "<button class='btn btn-sm btn-flat btn-info'><a style='color: white;' href='?table=client&type=status&operation=deactive&id=".$row['Id']."'>Actived</a></button>";

              
                }else{
                   echo "<button class='btn btn-danger btn-sm  btn-flat'><a style='color: white;' href='?table=client&type=status&operation=active&id=".$row['Id']."'>Deactived</a></button>";
                }echo "
