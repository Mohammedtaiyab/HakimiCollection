                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          ...
                          <td>".$row['ID']."</td>
                            ...
                            <td>";
                              if($row['Status']==1){
                                  echo "<button class='btn btn-sm btn-flat btn-info'><a style='color: white;' href='?table=banner&type=status&operation=deactive&id=".$row['ID']."'>Actived</a></button>";

              
                }else{
                   echo "<button class='btn btn-danger btn-sm  btn-flat'><a style='color: white;' href='?table=banner&type=status&operation=active&id=".$row['ID']."'>Deactived</a></button>";
                }echo "
