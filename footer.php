                          ...
                          <div class="row ">
                              <div id='<?php echo "quickView".$item['proID']; ?>' class="carousel slide" data-ride="carousel">
                                  ...
                                  <div class="carousel-inner">
                                    ...
                                    <?php $imgs=preg_split("/\,/", $item['Image']);?>
<img class="img-fluid" src='images/product/<?php echo $imgs[0];?>' alt="Product Image">
                                    </div>

                                    <?php for ($i=1; $i < count($imgs); $i++) { ?>

<span class="carousel-item"><img class="img-fluid" src='images/product/<?php echo $imgs[$i];?>' alt="Product Image"></span>
<?php } ?>
<?php 
                          ...
                          ?>  </a></div>
                              ...
                              <div class="pro-counter">
                                ...
                                <form method="POST" action='?action=add&pid=<?php echo $item['ID'];?>'>
                                  ...
                                  <input type="hidden" id='quantity<?php echo $item['ID'];?>' name="quantity" class="form-control quantity " value="1">
                  ...
                  <div class="single-footer">
                    ...
                    <div class="pro-about">
                        ...
                        <ul class="pl-0 mb-0">
                         ...
                         <li> <span>Hakimi Collection is a genuine <br> online clothing store in Kuwait.</span> </li>
                      <li><i class="fab fa-phone" aria-hidden="true"></i><span>+965 9786 5291</span><span><a href="#">sales@hakimicollection.com</a> </span> </li>
                ...
                <div class="col-12 col-lg-3">
                  <div class="single-footer">
                      <div class="pro-socials">
                          <h5>Follow Us</h5>
                          <ul>
                               <li><a href="mailto:hakimicollection@gmail.com" class="fab tw fa-google"></a></li>
                          <li><a href="https://api.whatsapp.com/send?phone=919660877053" class="fab sk fa-whatsapp"></a></li>
                          <li><a href="https://www.instagram.com/hakimicollection/" class="fab ig fa-instagram"></a></li>
                          </ul>
                      </div>
